        ...
        foreach (var dataChange in changes)
        {
            switch (dataChange.Field)
            {
                ...
                case "rX":
                    ...
                    break;
                case "rY":
                    _character.SetRoateY((float)dataChange.Value);
                    break;
                case "sY":
                    scale.y = (float)dataChange.Value;
                    break;
                default:
                    Debug.LogWarning("Don't work change for field:" + dataChange.Field);
                    break;
            }
        }
        _character.SetMovement(position,velocity,scale,AverageInterval);
    }
}
